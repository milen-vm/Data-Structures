...
public class MyDictonary<TKey, TValue> : IEnumerable<KeyValue<TKey, TValue>>
{
    ...
    private void Grow()
    {
        var newMyDictonary = new MyDictonary<TKey, TValue>(this.Capacity * 2);
        foreach (var element in this)
        {
            newMyDictonary.Add(element.Key, element.Value);
        }

        this.slots = newMyDictonary.slots;
        this.Count = newMyDictonary.Count;
    }
